...
| 5225 | total_balance includes superseded RBF transactions | still-valid | high | reproduced deterministically on master 606321b66: 6.00 -> 7.00 -> 8.00 BTC across two BumpFee replacements; btcwallet keeps replaced unmined txs until confirmation and sweeper never calls RemoveDescendants on replace (sweeper.go:1727) |
